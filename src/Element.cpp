...
Element::Element(const Operation operation)
    : m_value(0), m_operation(operation) {
  // do nothing, using member initialisation list
}
...
Element::Element(const Element& other)
    : m_value(other.m_value), m_operation(other.m_operation) {
  // do nothing, using member initialisation list
}
...
int Element::getValue() const { return m_value; }

Operation Element::getOperation() const { return m_operation; }

bool Element::isNumber() const { return m_operation == NUMBER; }
