...
std::vector<std::vector<Element> > eqs2 { { Element(4), Element(5), Element(PLUS) },
                                          { Element(5), Element(4), Element(PLUS) },
                                          { Element(4), Element(5), Element(MINUS) },
                                          { Element(5), Element(4), Element(MINUS) },
                                          { Element(4), Element(5), Element(MULTIPLY) },
